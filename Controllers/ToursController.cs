    ...
    public class ToursController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sales != null ? 
                          ...
                          Problem("Entity set 'TravAgenDBContext.Sales'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tours = await _context.Sales
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tours = await _context.Sales.FindAsync(id);
            if (tours == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TravAgenDBContext.Sales'  is null.");
            }
            var tours = await _context.Sales.FindAsync(id);
            if (tours != null)
            {
                _context.Sales.Remove(tours);
            }
