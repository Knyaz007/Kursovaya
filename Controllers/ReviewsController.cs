...
namespace Kursovaya.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(TravAgenDBContext context)
        {
            _context = context;
        }
        ...
        {
            var travAgenDBContext = _context.Review.Include(r => r.Tour).Include(r => r.User);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,TourId,UserId,Comment,Rating")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,TourId,UserId,Comment,Rating")] Review review)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TravAgenDBContext.Review'  is null.");
            }
            var review = await _context.Review.FindAsync(id);
            if (review != null)
            {
